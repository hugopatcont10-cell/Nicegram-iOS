...
public extension TelegramEngine {
    final class Messages {
        ...
        public func allMessages(peerId: PeerId, namespace: MessageId.Namespace) -> Signal<[Message], NoError> {
            return self.account.postbox.transaction { transaction -> [Message] in
                return transaction.allMessages(peerId, namespace: namespace)
            }
        }
        //
